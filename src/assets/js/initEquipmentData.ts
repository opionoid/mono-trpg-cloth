  ...
  db.collection("weaponStones")
    ...
    .then(querySnapshot => {
      ...
      weaponStones.map((weaponStone) => {
        ...
        if (weaponStone.name == null) weaponStone.name == `仮変質石${weaponStone.id}`
        ...
        if (weaponStone.skill1ChangedTarget == null) weaponStone.skill1ChangedTarget = ''
        if (weaponStone.skill1Ratio == null) weaponStone.skill1Ratio = 1
        if (weaponStone.skill2ChangedTarget == null) weaponStone.skill2ChangedTarget = ''
